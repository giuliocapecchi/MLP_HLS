...
\begin{itemize}
    \item \textbf{Dataset Preparation}: Loading the chosen dataset for training the model.
...
\begin{itemize}
    ...
    \item \texttt{architecture.h}: contains the definition of the architecture and the forward pass function prototype.
...
It is important to note that the directives discussed in this section represent only a subset of the directives executed by the HLS compiler during the synthesis process. These directives were explicitly added to address specific warnings and improve the design's performance. They were placed at the exact lines of code where they were required to resolve issues or optimize critical sections of the implementation.
